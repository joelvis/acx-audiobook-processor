...
def process_audio_file(input_path, output_path):
    ...
    try:
        ...
        ffmpeg_command = [
            ...
            'loudnorm=I=-20:TP=-3:LRA=11:measured_I=-32,'  # RMS normalization to -20dB with -3dB peak
            'volume=volume=2.1,'  # Volume adjustment after normalization
            'alimiter=level=1.0:limit=-3dB:attack=5:release=50',  # Final limiter for peak control
